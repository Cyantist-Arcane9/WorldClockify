...
public class CountryTimeZone {
    ...
    public static Map<String, Country> getTzCountryMap() {
        Map<String, Country> tzCountryMap = new HashMap<String, Country>();
...
//    public static synchronized List<TimeZonify> getSupportedTimezones(){
//        List<TimeZonify> allTimeZones = new ArrayList<TimeZonify>();
//        Set<String> supportedZones = tzCountryMap.keySet();
//        allTimeZones = new ArrayList<TimeZonify>(supportedZones.size());
//        for (String tz : supportedZones) {
//            allTimeZones.add(TimeZonify(TimeZone.getTimeZone(tz)));
//        }
//
